...
const validUserExist_guard_1 = require("../core/guards/validUserExist.guard");
let AuthController = class AuthController {
    ...
    signup(user) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.authService.signup(user);
        });
    }
    login(user) {
        return __awaiter(this, void 0, void 0, function* () {
...
__decorate([
    (0, common_1.UseGuards)(validUserExist_guard_1.ValidUserExist),
